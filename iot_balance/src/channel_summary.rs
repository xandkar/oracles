...
use crate::subnetwork_rewards::SubnetworkRewards;
...
use helium_proto::{
    ...
    BlockchainStateChannelStateV1 as StateChannelState,
    BlockchainStateChannelSummaryV1 as StateChannelSummary,
    BlockchainStateChannelV1 as StateChannel
};
...
pub struct ChannelSummary(pub Vec<ProtoSubnetworkReward>);
